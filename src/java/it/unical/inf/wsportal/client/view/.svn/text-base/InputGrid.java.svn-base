 ...
 */
public class InputGrid extends EditorGrid<BaseModelData> {

    private static int instance = 0;

    public InputGrid(ListStore<BaseModelData> store, ColumnModel model) {
        super(store, model);
        instance++;
        setID(ComponentID.INPUT_GRID + "-" + instance);
        setProperties();
    }
