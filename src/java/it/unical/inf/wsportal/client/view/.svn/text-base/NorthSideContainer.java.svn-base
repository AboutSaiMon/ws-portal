 ...
 */
public class NorthSideContainer extends LayoutContainer {
     ...
     *
     */
    public NorthSideContainer() {
        super();
        setID(ComponentID.NORTH_SIDE_CONTAINER);
        setComponents();
    }
    ...
    private void setComponents() {
        ...
        Session.setUsername(usernameLabel);
        add(usernameLabel);
    }
}
